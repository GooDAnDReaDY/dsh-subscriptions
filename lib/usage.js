...
const WINDOW_LABELS = {
  five_hour: { zh: "5小时", ru: "5ч", en: "5h" },
  seven_day: { zh: "7天", ru: "7д", en: "7d" },
  seven_day_oauth_apps: { zh: "7天应用", ru: "7д прил.", en: "7d apps" },
  weekly_limit_7_days: { zh: "7天", ru: "7д", en: "7d" },
  primary: { zh: "主配额", ru: "осн.", en: "primary" },
  secondary: { zh: "次配额", ru: "втор.", en: "secondary" },
  // codex: the vendor API returns primary_window/secondary_window - surfaced as 5h/7d in the UI
  primary_window: { zh: "5小时", ru: "5ч", en: "5h" },
  secondary_window: { zh: "7天", ru: "7д", en: "7d" },
  monthly: { zh: "月度", ru: "месяц", en: "month" },
  credits: { zh: "点数", ru: "кредиты", en: "credits" },
}

export function windowLabel(id) {
  const known = WINDOW_LABELS[id]
  return known || { zh: id, ru: id, en: id }
}
