            ...
            React.createElement('table', { style: { width: '100%', fontSize: '12px', borderCollapse: 'collapse' } },
              React.createElement('thead', null,
                React.createElement('tr', { style: { borderBottom: '1px solid var(--dsw-alias-border-primary, rgba(255,255,255,0.1))', textAlign: 'left', opacity: 0.7 } },
                  React.createElement('th', { style: { padding: '6px' } }, 'Account'),
                  React.createElement('th', { style: { padding: '6px' } }, 'Health'),
                  React.createElement('th', { style: { padding: '6px' } }, 'Latency'),
                  React.createElement('th', { style: { padding: '6px' } }, 'Status'),
                  React.createElement('th', { style: { padding: '6px' } }, 'Quota / Runway'),
                ),
              ),
              React.createElement('tbody', null,
                accounts.map((acc, idx) => {
                  ...
                  const statusLabel = isQ ? '⛔ Quarantine' : (acc.status === 'probing' ? '🟡 Warmup' : (acc.configured ? '🟢 Active' : '⚪ Idle'))
